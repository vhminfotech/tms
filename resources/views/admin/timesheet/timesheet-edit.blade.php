            ...
            <div class="c-tabs">
                <div class="c-tabs__content tab-content" id="nav-tabContent">
                    <div class="c-tabs__pane active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <form name="edit-workplaces" id="editWorkplaces" action="{{ route('workplaces-edit',$timesheetDetail[0]['id']) }}" method="post">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="c-field u-mb-small">
										...
										<input class="c-input" type="hidden" name="workplaces_id" id="workplaces_id" value="{{ $timesheetDetail[0]['id'] }}"> 
                                    </div>
