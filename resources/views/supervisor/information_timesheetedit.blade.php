                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="c-field u-mb-small">
                                        ...
                                        <input id="start_time" name="timesheet_edit_start_time" class="c-input" type="text" value="{{ $objinformationreason[0]['start_time'] }}"/>
                                    </div>
                                    <div class="c-field u-mb-small">
                                        <label class="c-field__label" for="adresses">{{ trans('words.end-time') }}</label>   
                                        <input id="end_time" name="timesheet_edit_end_time" class="c-input" type="text" value="{{ $objinformationreason[0]['end_time'] }}"/>
                                    </div>
                                    <div class="c-field u-mb-small">
                                        <label class="c-field__label" for="adresses">{{ trans('words.pause-time') }}</label>   
                                        <input id="pausetime" name="timesheet_edit_push_time" class="c-input" type="text" value="{{ $objinformationreason[0]['pause_time'] }}"/>
                                    </div>
                                    
                                    <div class="c-field u-mb-small">
                                        <label class="c-field__label" for="adresses">{{ trans('words.reason') }}</label>   
                                        <input id="inforamtion" name="inforamtion" class="c-input" type="text" value="{{ $objinformationreason[0]['reason'] }}"/>
                                    </div>
